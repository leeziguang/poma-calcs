...
export const FieldEffect = ({ name, pairName }: IFieldEffectProps) => {
  const fieldPath = (field: EFieldEffectFormFields) => [
  ...
  return (
    <Form.Item noStyle shouldUpdate>
      {({ getFieldValue }) => {
        ...
        const headerVal = calcFieldEffect({
        ...
        return (
          <Collapse className="fieldEffect-collapse" defaultActiveKey={[name]}>
            ...
            >
                  ...
                  return (
                    <Card className="fieldEffect-circle-card">
                      ...
                      {fields?.map(field => (
                        <div
                          key={field.key}
                          className="fieldEffect-circle-wrapper"
                        >
                          <Form.Item
                            label="Circle Type"
                            name={[
                              field.name,
                              EFieldEffectFormFields.CIRCLE_MULTI
                            ]}
              ...
              <Form.Item
                label="Rebuff"
                name={[name, EFieldEffectFormFields.REBUFF]}
              >
